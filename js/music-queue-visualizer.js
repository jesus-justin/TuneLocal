...
class MusicQueueVisualizer {
    ...
    addStyles() {
        ...
        style.textContent = `
            .queue-visualizer { position: fixed; left: 20px; bottom: 20px; background: linear-gradient(135deg, rgba(29, 185, 84, 0.1), rgba(29, 185, 84, 0.05)); border: 1px solid rgba(29, 185, 84, 0.3); border-radius: 12px; padding: 1rem; min-width: 220px; max-width: 260px; max-height: 35vh; overflow-y: auto; color: var(--text-primary); z-index: 960; }
            ...
            @media (max-width: 900px) {
                .queue-visualizer { left: 12px; bottom: 12px; max-width: 220px; }
            }
        `;
